...
--Guest Bookings
insert into booking2 values ( 7433, to_date('2025-09-01','YYYY-MM-DD'), 8 );
insert into booking2 values ( 7434, to_date('2025-09-01','YYYY-MM-DD'), 8 );
insert into booking2 values ( 7435, to_date('2025-09-01','YYYY-MM-DD'), 8 );

insert into booking2 values ( 7436, to_date('2025-09-01','YYYY-MM-DD'), 9 );
insert into booking2 values ( 7437, to_date('2025-09-01','YYYY-MM-DD'), 9 );

insert into booking2 values ( 7438, to_date('2025-09-01','YYYY-MM-DD'), 10 );
